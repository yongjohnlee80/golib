...
// Tree mechanics and node hierarchy tests:
//   - Component lifecycle order (Init -> Layout -> Render)
//   - Mount / unmount cascade and context cancellation
//   - LIFO OnUnmount hooks (children before parents)
//   - Dead-letter handling for unmounted nodes
//   - Dynamic type comparability requirement
//   - Duplicate mount prevention
//   - Tree mutation guards during Layout/Render
//   - Node move semantics and identity preservation across reorder
...
// TestTreeMutationInsideLayoutPanics: Mount/Unmount are illegal inside Layout.
